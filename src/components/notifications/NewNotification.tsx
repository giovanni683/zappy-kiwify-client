...
export function NewNotification({ onBack }: NewNotificationProps) {
	...
	function handleSubmit(e: React.FormEvent) {
		...
		return (
			<div
				className="page-container mx-auto w-full max-w-[420px] min-h-screen bg-[#F9FAFB] flex flex-col items-start relative"
			...
			>
				...
				<div
					className="flex flex-col items-start gap-4 rounded-2xl shadow-none p-0 min-h-[600px] w-full max-w-[388px] mt-4"
